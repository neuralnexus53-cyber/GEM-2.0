...
export const mockProfiles: Record<string, VendorProfile> = {
  ...
  AUTHORIZED_RESELLER: {
    id: 'VEND-RES-3412',
    name: 'Novavolt Commercial & Reseller Solutions Pvt Ltd',
    role: 'AUTHORIZED_RESELLER',
    gstin: '27AABCN8712P1ZL',
    pan: 'AABCN8712P',
    cin: 'U31900MH2021PTC367890',
    gemSellerId: 'GEM-SEL-RES-3412',
    registeredAddress: 'Unit 8, MIDC Electronic Zone, Mahape, Navi Mumbai 400710',
    gemStarRating: 4.9,
    turnoverCr: 4.2,
    experienceYears: 3,
    udyamNumber: 'UDYAM-MH-03-0098412',
    dpiitRegistered: true,
    brandName: 'Authorized ApexPower™ Reseller',
    oemCertifications: ['ISO 9001:2015', 'OEM MAF Validated: APX-2026-DEL', 'DPIIT Startup ID: DIPP98214'],
    miiPercentage: 88,
    complianceScore: 92,
    riskAlertsCount: 2,
  ...
  SERVICE_PROVIDER: {
    id: 'VEND-SRV-7105',
    name: 'Bharat Infra-Tech & Integrated Facility Services',
    role: 'SERVICE_PROVIDER',
    gstin: '29AAGCB5541Q1ZP',
    pan: 'AAGCB5541Q',
    cin: 'U45200KA2015PLC089123',
    gemSellerId: 'GEM-SEL-SRV-7105',
    registeredAddress: 'Infra Tower, Outer Ring Road, Bellandur, Bengaluru 560103',
    gemStarRating: 4.7,
    turnoverCr: 32.8,
    experienceYears: 12,
    contractorClass: 'Class-1 Super (Manpower, Facility & Works EPC)',
    oemCertifications: ['ISO 14001', 'OHSAS 18001 Safety', 'CPWD Class-1 Enlistment', 'GeM SLA Certified Provider'],
    miiPercentage: 92,
    complianceScore: 89,
    riskAlertsCount: 4,
...
export const mockDigiLockerDocs: DigiLockerDocument[] = [
  {
    id: 'DL-GST-01',
    docType: 'GST_CERT',
    title: 'GST Registration Certificate (Form GST REG-06)',
    issuer: 'Goods and Services Tax Network (GSTN)',
    issuerOrgId: 'in.gov.gst',
    docNumber: '07AAACA4952J1ZM',
    issueDate: '12-Jul-2017',
    validUntil: 'PERPETUAL',
    uri: 'in.gov.gst-cert-07AAACA4952J1ZM',
    sha256Hash: 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS GSTN GOV OF INDIA 01',
    fileSize: '1.2 MB',
    isPulled: true,
    category: 'TAX_CORP',
    extractedData: {
      legalName: 'Apex Dynamics & Energy Systems Ltd.',
      tradeName: 'ApexPower Systems',
      constitution: 'Public Limited Company',
      jurisdictionState: 'Delhi',
      filingCompliance: '100% On-Time (36 Consecutive Months)'
    }
  },
  {
    id: 'DL-UDYAM-02',
    docType: 'UDYAM_MSME',
    title: 'Udyam Registration Certificate (Micro/Small/Medium)',
    issuer: 'Ministry of Micro, Small and Medium Enterprises',
    issuerOrgId: 'in.gov.msme.udyam',
    docNumber: 'UDYAM-DL-08-0094182',
    issueDate: '18-Nov-2020',
    validUntil: 'ACTIVE_FY26',
    uri: 'in.gov.msme.udyam-cert-UDYAM-DL-08-0094182',
    sha256Hash: '9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS MSME UDYAM VERIFICATION AUTHORITY',
    fileSize: '840 KB',
    isPulled: true,
    category: 'MSME_QUALITY',
    extractedData: {
      enterpriseType: 'Medium Enterprise (Manufacturing)',
      majorActivity: 'Manufacturing of Heavy Electrical & SCADA Units',
      nic2Digit: '27 - Manufacture of electrical equipment',
      dicDistrict: 'South East Delhi'
    }
  },
  {
    id: 'DL-PAN-03',
    docType: 'PAN_CARD',
    title: 'Permanent Account Number (PAN Card Form 49A)',
    issuer: 'Income Tax Department (CBDT)',
    issuerOrgId: 'in.gov.incometax',
    docNumber: 'AAACA4952J',
    issueDate: '04-Feb-2015',
    validUntil: 'PERPETUAL',
    uri: 'in.gov.incometax-pan-AAACA4952J',
    sha256Hash: '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS INCOME TAX DEPT GOVT OF INDIA',
    fileSize: '620 KB',
    isPulled: true,
    category: 'TAX_CORP',
    extractedData: {
      entityName: 'APEX DYNAMICS & ENERGY SYSTEMS LIMITED',
      incorporationDate: '14/01/2015',
      panStatus: 'OPERATIVE & AADHAAR LINKED',
  ...
  },
  {
    id: 'DL-MCA-04',
    docType: 'CORP_INC',
    title: 'Certificate of Incorporation (CIN / RoC)',
    issuer: 'Ministry of Corporate Affairs (MCA-21)',
    issuerOrgId: 'in.gov.mca',
    docNumber: 'L31900DL2015PLC275142',
    issueDate: '14-Jan-2015',
    validUntil: 'PERPETUAL',
    uri: 'in.gov.mca-cin-L31900DL2015PLC275142',
    sha256Hash: '4b227777d4dd1fc61c6f884f48641d02b4d121d3fd328cb08b5531fcacdabf8a',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS REGISTRAR OF COMPANIES DELHI',
    fileSize: '2.1 MB',
    isPulled: true,
    category: 'TAX_CORP',
    extractedData: {
      authorizedCapital: '₹ 50,00,00,000',
      paidUpCapital: '₹ 38,50,00,000',
      rocOffice: 'RoC Delhi & Haryana',
      activeDirectorsCount: 4
    }
  },
  {
    id: 'DL-ITR-05',
    docType: 'ITR_V',
    title: 'ITR-V Income Tax Return Acknowledgement (3-Year Consolidated)',
    issuer: 'Central Board of Direct Taxes (CPC Bengaluru)',
    issuerOrgId: 'in.gov.incometax.efiling',
    docNumber: 'ITR-772190841289',
    issueDate: '28-Oct-2025',
    validUntil: 'FY 2024-25',
    uri: 'in.gov.incometax.efiling-itrv-772190841289',
    sha256Hash: 'ef2d127de37b942baad06145e54b0c619a1f22327b2ebbcfbec78f5564afe39d',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS CPC INCOME TAX BENGALURU',
    fileSize: '1.8 MB',
    isPulled: true,
    category: 'FINANCIAL_WORKS',
    extractedData: {
      assessmentYear: '2025-26',
      grossTotalIncome: '₹ 48,52,40,000',
      taxPaid: '₹ 12,18,60,000',
      filingMode: 'e-Filed with Digital Signature (Class-3)'
    }
  },
  {
    id: 'DL-UDIN-06',
    docType: 'CA_NETWORTH',
    title: 'Chartered Accountant Net Worth & Turnover Certificate (ICAI UDIN)',
    issuer: 'Institute of Chartered Accountants of India (ICAI)',
    issuerOrgId: 'in.org.icai.udin',
    docNumber: '25098412AAAAZY7821',
    issueDate: '15-Sep-2025',
    validUntil: '31-Mar-2026',
    uri: 'in.org.icai.udin-cert-25098412AAAAZY7821',
    sha256Hash: '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'CA R.K. SINGHANIA & ASSOCIATES (FCA 098412)',
    fileSize: '1.4 MB',
    isPulled: false,
    category: 'FINANCIAL_WORKS',
    extractedData: {
      averageTurnover3Years: '₹ 48.50 Crores',
      auditedNetWorth: '₹ 62.40 Crores',
      solvencyAmount: '₹ 15.00 Crores',
      udinStatus: 'ACTIVE & UNREVOKED'
    }
  },
  {
    id: 'DL-CPWD-07',
    docType: 'CPWD_ENLIST',
    title: 'CPWD Central Enlistment Order (Class-1 Super / Unlimited)',
    issuer: 'Central Public Works Department (Director General Works)',
    issuerOrgId: 'in.gov.cpwd',
    docNumber: 'CPWD/ENL/CIVIL/SUPER-8902',
    issueDate: '02-Jun-2024',
    validUntil: '01-Jun-2029',
    uri: 'in.gov.cpwd-enlist-SUPER-8902',
    sha256Hash: '2c624232cdd221771294dfbb310aca000a0df6ac9b66b0d199f43f34f6ba783b',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS SPECIAL DG CPWD NEW DELHI',
    fileSize: '2.4 MB',
    isPulled: false,
    category: 'FINANCIAL_WORKS',
    extractedData: {
      tenderingLimit: 'UNLIMITED (Above ₹ 150 Crores)',
      categoryOfWorks: 'Building & Infrastructure EPC',
      solvencyRequired: '₹ 25.00 Crores',
      performanceTrackRecord: 'EXCELLENT'
    }
  },
  {
    id: 'DL-ISO-08',
    ...
    issuer: 'National Accreditation Board for Certification Bodies (NABCB / QCI)',
    issuerOrgId: 'in.org.qcin.nabcb',
    docNumber: 'NABCB-QMS-2023-88914',
    issueDate: '10-Jan-2023',
    validUntil: '09-Jan-2026',
    uri: 'in.org.qcin-cert-QMS-2023-88914',
    sha256Hash: '19581e27de7ced00ff1ce50b2047e7a567c76b1cbaebabe5ef03f7c3017bb5b7',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS NABCB CHIEF EXECUTIVE',
    fileSize: '1.1 MB',
    isPulled: true,
    category: 'MSME_QUALITY',
    extractedData: {
      standard: 'ISO 9001:2015 & ISO 14001:2015',
      scopeOfSupply: 'Design, Engineering, Assembly of Power Quality Inverters',
      accreditationStatus: 'IAF MLA Signatory Valid'
    }
  },
  {
    id: 'DL-KYC-09',
    docType: 'AADHAAR_KYC',
    title: 'Aadhaar e-KYC Signatory Certificate (Masked UID)',
    issuer: 'Unique Identification Authority of India (UIDAI)',
    issuerOrgId: 'in.gov.uidai',
    docNumber: 'XXXX-XXXX-8924',
    issueDate: '01-Jan-2026',
    validUntil: 'PERPETUAL',
    uri: 'in.gov.uidai-ekyc-8924',
    sha256Hash: 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3',
    xmlSignatureStatus: 'VERIFIED',
    digitalSigner: 'DS UIDAI SIGNING AUTHORITY',
    fileSize: '480 KB',
    isPulled: true,
    category: 'IDENTITY',
    extractedData: {
      signatoryName: 'Vikramaditya Sharma',
      designation: 'Managing Director & Authorized Bidder',
      authMethod: 'Biometric + OTP Multi-Factor Authentication',
      securityCompliance: 'MeitY Aadhaar Act 2016 Compliant'
    }
  }
];